...
import { validateInput, pathExists, sanitizePath, createError, ErrorCode, } from '../utils/common.js';
import { DatabaseService } from './database/database-service.js';
import { requireProject, getOptionalNumberArg, getOptionalStringArg, getOptionalBooleanArg, getStringArg, } from './types.js';
export const openProjectHandler = {
    ...
    handler: async (args, context) => {
        ...
        if (!(await pathExists(projectPath))) {
            throw createError(ErrorCode.FILE_NOT_FOUND, { path: projectPath }, `Project path does not exist: ${projectPath}`);
        }
...
export const getStructureHandler = {
    name: 'get_structure',
...
export const refreshProjectHandler = {
...
export const closeProjectHandler = {
    name: 'close_project',
